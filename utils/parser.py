...
def get_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='enable gan net or not'
    )
    parser.add_argument(
        '--generate',
        action='store_true',
        default=False,
        help='enable generate cloud'
    )
    parser.add_argument(
        '--config', 
        type = str, 
    ...
    parser.add_argument(
        ...
        default='none',
        help='job launcher')     
    parser.add_argument('--local_rank', type=int, default=0)  #这个是干吗的？
    ...
    parser.add_argument('--ckptsG', type=str, default=None, help='test used ckptG path')
    ...
    if 'LOCAL_RANK' not in os.environ:  #这个节点中的gpu id
